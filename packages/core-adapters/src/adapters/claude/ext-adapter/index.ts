...
export {
  fetchConversation as fetchClaudeConversation,
  extractConversationId as extractClaudeConversationId,
  extractOrgIdFromCookie as extractClaudeOrgId,
};
...
export class ClaudeExtAdapter extends BaseExtAdapter {
  ...
  async getRawMessages(
    ...
    const rawMessages = convertClaudeMessagesToRawMessages(chatMessages);
    ...
    return { rawMessages, title: data.name };
  }
}
